                                        ...
                                        {item.list.map((item1, index1) => {
                                            return(
                                                <div key={item1 + index1} className="item">
                                                    <div className="select_wrap" onClick={this.selectItem.bind(this, item1)}>
                                                    {item1.checked && (
                                                        <img
                                                            className="select"
                                                    ...
                                                    <div className="item_wrap">
                                                        ...
                                                        <div className="bottoms">
                                                            ...
                                                            <div className="operate">
                                                                <span className="operate-click" onClick={this.reduce.bind(this, item1)}>-</span>
                                                                <span className="operate-click operate-num">{item1.num}</span>
                                                                <span className="operate-click" onClick={this.increase.bind(this, item1)}>+</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div  className="delete-item" onClick={this.deleteItem.bind(this, item1, index1)}>删除</div>
                                                </div>
                                            )
                                        })}
                                    </div>
